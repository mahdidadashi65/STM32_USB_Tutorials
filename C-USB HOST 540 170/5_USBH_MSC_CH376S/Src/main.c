...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, AT45DB_CS_Pin|CH376S_CS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : AT45DB_CS_Pin CH376S_CS_Pin */
  GPIO_InitStruct.Pin = AT45DB_CS_Pin|CH376S_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : CH376S_INT_Pin */
  GPIO_InitStruct.Pin = CH376S_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(CH376S_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CH376S_BUSY_Pin */
  GPIO_InitStruct.Pin = CH376S_BUSY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(CH376S_BUSY_GPIO_Port, &GPIO_InitStruct);
