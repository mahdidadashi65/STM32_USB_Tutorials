...
#define MySD_SEL HAL_GPIO_WritePin(MMC_CS_GPIO_Port, MMC_CS_Pin, GPIO_PIN_RESET)
#define MySD_DESEL HAL_GPIO_WritePin(MMC_CS_GPIO_Port, MMC_CS_Pin, GPIO_PIN_SET);
